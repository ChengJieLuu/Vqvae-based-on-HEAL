...
def assign_modality_4_in_order(root_dir="/datasets/OPV2V", output_path="opencood/logs/heter_modality_assign/opv2v_4modality_in_order.json"):
    """
...
if __name__ == "__main__":
    ...
    # assign_modality_4('/datasets/OPV2V', output_path='opencood/logs/heter_modality_assign/opv2v_4modality.json')
