...
class PillarVFEVFE2Avg(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        #目标处理方法1：对32取平均
        # features = torch.mean(features, dim=1, keepdim=True)  # [7332, 32, 10] -> [7332, 1, 10]
        # features = features.squeeze()

        # 目标处理方法2：直接embedding成32*10
        features = features.reshape(features.size(0), -1)  # [7697, 32, 10] -> [7697, 320]
